...
- Volume 4 dictionary lessons 7–8 were verified and imported on 2026-09-02 from five owner photographs: printed lesson 24, pages 180–181 → application lesson 7 (21 source rows, 23 cards); printed lesson 25, pages 182–184 → application lesson 8 (39 source rows, 49 cards). All 12 plurals have separate Russian plural meanings. Source: `data/book4-dictionary-lessons7-8.json`; migration: `20260902190000_import_book4_dictionary_lessons07_08.sql`. Exact reverse comparison, both dictionary views, five training pools and daily-goal plans passed; other words/student progress are unchanged. Details and rollback reference: `docs/MEDINA_BOOK4_DICTIONARY_PROGRESS.md`.
- Book 4 dictionary is complete through application lesson 17 (printed 34), 917 live cards. On 2026-09-02, 27 complete owner Drive photos (pages 185–211) supplied lessons 9–17: 347 source rows / 453 cards / 106 singular-plural pairs. Migration `20260902220000_import_book4_dictionary_lessons09_17.sql` replaced only 54 exact corrupt placeholders; all other words and student data were preserved. Source/corrections/backup/QA: `docs/MEDINA_BOOK4_DICTIONARY_PROGRESS.md`; source data and photo hashes: `data/book4-dictionary-lessons9-17*.json`.
- Canonical Book 4 dictionary mapping is `application lesson = printed lesson − 17` throughout printed lessons 18–34. All photo blocks are imported; do not restart or renumber them. New requests for rules/sharh are separate from vocabulary completion.
