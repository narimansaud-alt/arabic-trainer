...
- Canonical Book 4 dictionary mapping is `application lesson = printed lesson − 17`: 18→1, 19→2, 20→3, 21→4, 22→5, 23→6, 24→7, 25→8. Next vocabulary photo block: printed 26 → application 9. Do not infer a different mapping from missing photo blocks.
